...
public class NutritionInfoCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutrition_info_category);
        ...
        adapter = new NutritionInfoAdapter();
    ...
    private void getArticle() {
        try {
            ...
            json.key("article_type").value("nutrition_info");
            json.key("article_tags").value(category);
            json.endObject();
